...
function Model({ path, position, onClick }) {
  ...
  return (
    <primitive
      ...
      onClick={onClick}
      onPointerOver={(e) => (
        e.stopPropagation(), (e.target.style.cursor = "pointer")
      )}
      onPointerOut={(e) => (
        e.stopPropagation(), (e.target.style.cursor = "default")
      )}
    />
  );
}
          ...
          <div className="question-overlay">
            <div className="container-questions">
              ...
              <p className="p-questions">
                ¿Cuál es una de las principales causas de la deforestación a
                nivel mundial?
              </p>
              <div className="container-buttons-questions">
                ...
                <button onClick={() => handleAnswer("b")}>
                  b) La agricultura y ganadería extensiva
                </button>
                <button onClick={() => handleAnswer("c")}>
                  c) La energía renovable
                </button>
        ...
        <KeyboardControls map={map}>
          <Canvas camera={{ position: [0, 1, 0] }}>
            <Suspense fallback={null}>
              ...
              <Lights />
              <Model
                path="/characters/Avatars/Seed.glb"
                position={[30, 1, 35]}
              ...
              <Text
                ...
                anchorY="middle"
              >
                La deforestación afecta a nuestra biodiversidad y calidad del
                aire
              </Text>
              <Text
                position={[20, 10, 10]}
