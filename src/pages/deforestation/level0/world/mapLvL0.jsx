...
const MapLvL0 = (props) => {
  const { nodes, materials } = useGLTF('/models-3d/mapLvL0.glb');
  return (
...
export default MapLvL0;

useGLTF.preload('/models-3d/mapLvL0.glb');
